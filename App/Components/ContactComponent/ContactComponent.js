...
class ContactComponent extends Component {
  ...
  // Actions.transactioncomponent({type:'reset'})
    ...
    render() {
        // debugger;
        // const braintree = braintree.dropin.create();
        ...
        return (
         <View style={{flex:1}}>
          ...
          <Text style={{textAlign:"center",color:'black',fontWeight:"600",marginTop:40,marginBottom:20,fontSize:18,marginLeft:20,marginRight:20}}>{Strings.WHATS_YOUR_NAME}</Text>
         ...
         <MaterialTextInput
            ...
            <Text style={{color:'red',fontSize:20}}>X</Text>
             ...
             <View style={{flex:1,marginRight:30,flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
             <View style={{flex:1}}>
             <MaterialTextInput
