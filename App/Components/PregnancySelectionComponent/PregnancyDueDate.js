  ...
  getUserData(){
    AsyncStorage.getItem("UserInfo").then((value) => {
      ...
      if (value) {
          ...
          this.setState({preg_date:userData.preg_date,expected_box_date:userData.expected_box_date})
      }
  }).done();
     ...
     if(this.props.pregnancyreducer.pregnancyDuedateRes!=''){
       ...
       if(this.props.pregnancyreducer.pregnancyDuedateRes.status==="success"){
               ...
               console.log(this.state.pregnancySignupdata)
                AsyncStorage.setItem("UserInfo", JSON.stringify(this.props.pregnancyreducer.pregnancyDuedateRes.data));
...
submit(){
  ...
  postData = {
          ...
          savedScreen:STRINGS.SCREEN_THREE_YES
      };
