 ...
 getUserData(){
    AsyncStorage.getItem("UserInfo").then((value) => {
      ...
      if (value) {
          ...
          this.selectTheOption(userData.cloth_selector)
      }
  }).done();
...
componentDidUpdate(){
    if(this.props.whatToBuyReducer.whatToBuyRes!=''){
        ...
        if(this.props.whatToBuyReducer.whatToBuyRes.status === 'success'){
            AsyncStorage.setItem("UserInfo", JSON.stringify(this.props.whatToBuyReducer.whatToBuyRes.data));
 ...
 goToIntroScreen(){
  ...
  render() {
        return (
           ...
           <Text style={{textAlign:"center",color:"black",fontWeight:"600",marginTop:50,marginBottom:20,fontSize:18}}>WHO IS DECIDING WHAT TO BUY ?</Text>
           ...
           <Text style={{color:"black",fontSize:18,marginLeft:30,marginTop:16,marginBottom:16}}>Clothing based on the:</Text>
