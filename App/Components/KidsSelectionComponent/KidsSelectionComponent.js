...
this.getUserData();
 ...
 getUserData(){
    AsyncStorage.getItem("UserInfo").then((value) => {
        console.log(`Async userdata ${value}`);

      if (value) {
          var userData = JSON.parse(value);
          this.setState({userInfo:userData});
          this.setState({countKids:userData.total_kids})
          this.fillData(userData.total_kids);
      }
  }).done();
...
fillData(total_kids){
    this.selectKid(total_kids);
    this.selectEnrolledKid(total_kids);
...
componentDidUpdate(){
    if(this.props.kidsSelectionReducer.kidsSelectionRes!=''){
        ...
        if(this.props.kidsSelectionReducer.kidsSelectionRes.status==="success"){
            ...
            AsyncStorage.setItem("UserInfo", JSON.stringify(this.props.kidsSelectionReducer.kidsSelectionRes.data));
 ...
 selectKidsCount(){
    ...
    if(this.state.enrolledKidsCount==0){
        ...
        postData ={
            ...
            savedScreen:Strings.SCREEN_FOUR
         }
 ...
 selectKid(count){
     switch(count){
         ...
         case 5:
         case 6:
         console.log("more kids>>"+count)
         this.setState({countKids:0,isOneKidSelected:false,isTwoKidSelected:false,isThreeKidSelected:false})
         this.setState(prevState => ({ countKids: prevState.countKids + count }));
         break;
 ...
 renderEnrolledKids(){
     switch(this.state.countKids){
        case 1:
        return(
            <TouchableWithoutFeedback onPress={()=> this.selectEnrolledKid(1)}>
        ...
        return(
          ...
          <TouchableWithoutFeedback onPress={()=> this.selectEnrolledKid(1)}>
            ...
            <Text style={{marginTop:5}}>1 kid</Text>
              ...
              <TouchableWithoutFeedback onPress={()=> this.selectEnrolledKid(2)}>
              <View style={{flexDirection:"column",margin:15,justifyContent:"center",alignItems:"center"}}>
        ...
        return(
            ...
            <TouchableWithoutFeedback onPress={()=> this.selectEnrolledKid(3)}>
            <View style={{flexDirection:"column",margin:15,justifyContent:"center",alignItems:"center"}}>
...
console.log("Kids count>>"+JSON.stringify(this.state.userInfo))
      return (
             ...
             <TouchableWithoutFeedback onPress={()=> this.selectKid(1)}>
              ...
              <Text style={{marginTop:5}}>1 kid</Text>
               ...
               <TouchableWithoutFeedback onPress={()=> this.selectKid(2)}>
             <View style={{flexDirection:"column",margin:20,justifyContent:"center",alignItems:"center"}}>
             <Image source={(this.state.isTwoKidSelected)?require('../../Assets/2kidsel.png'):require('../../Assets/2kidUnsel.png')}/>
             <Text style={{marginTop:5}}>2 kid</Text>
             </View>
             </TouchableWithoutFeedback>
             <TouchableWithoutFeedback onPress={()=> this.selectKid(3)}>
             <View style={{flexDirection:"column",margin:20,justifyContent:"center",alignItems:"center"}}>
