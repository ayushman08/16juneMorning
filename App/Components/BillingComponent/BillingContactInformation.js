    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <ScrollView style={{ flex: 1 }}>
                    <Text style={{ textAlign: "center", fontSize: 18, color: "black", fontWeight: "600", marginTop: 50, marginBottom: 30 }}>BILLING INFORMATION
          </Text>
      ...
      <MaterialTextInput
               ...
               /> </View> */}
                    ...
                    <View style={{ padding: 20 ,backgroundColor:Colors.TRANSPARENT}}>
                ...
                />
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                        <Button rounded style={{ width: width / 2.4, justifyContent: "center", margin: 15, alignItems: "center", backgroundColor: Colors.BUTTON_COLOR, padding: 0 }} onPress={() => { this.submit() }}>
                            <Text style={{ color: "white", textAlign: "center", fontWeight: "800", fontSize: 16 }}>{Strings.NEXT}</Text>
                        </Button>
                    </View>
