...
export default class DefaultSlide extends React.PureComponent {
 ...
 {/* <Image source={this.props.image} style={this.props.imageStyle} /> */}
 <View style={{height:"50%",width:"100%",backgroundColor:"#f6ede8",justifyContent:"center",alignItems:"center"}}>
 <Image source={this.props.image} style={this.props.imageStyle}/>

 </View>
 
 <View style={{backgroundColor:"white",width:"100%" ,height:200,marginTop:30,zIndex:10}}>
